...
//  $Id: GzStream.h,v 1.1.1.1 2008-07-28 19:25:53 kyoshida Exp $
//
//////////////////////////////////////////////////////////////////////

#ifndef Amis_GzStream_h_

#define Amis_GzStream_h_
...
public:
  ...
  /// Destructor
  virtual ~GzStreamUnsupportedError() {}
};
...
public:
  explicit IGzStreamBuf( std::istream&, size_type = DEFAULT_BUFFER_SIZE ) {
    throw GzStreamUnsupportedError( "zlib not supported" );
  }
  virtual ~IGzStreamBuf() {
  }
};
...
public:
  explicit OGzStreamBuf( std::ostream&,
